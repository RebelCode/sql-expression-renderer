...
use RebelCode\Expression\Renderer\Sql\SqlBetweenExpressionTemplate as TestSubject;
use Xpmock\TestCase;
 ...
 * @since [*next-version*]
 */
class SqlBetweenExpressionTemplateTest extends TestCase
{
    /**
    ...
    public function testRender()
    {
        ...
        $expected = "BETWEEN $render1 AND $render2";
